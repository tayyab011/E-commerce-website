...
const NAvbar = () => {
    return (
      <div className="navbar bg-orange-100 " data-theme="autumn">
        ...
        <div className="navbar-center">
          <Link
            to={"/"}
            id="ab"
            className=" normal-case text-2xl  text-red-900 italic "
          >
            Oikawa
          </Link>
        </div>
        ...
        <div className="navbar-end">
          ...
          <div className="flex-none">
            <div className="dropdown dropdown-end">
              ...
              <div
                tabIndex={0}
                className="mt-3 card card-compact dropdown-content w-52 bg-orange-200 shadow"
              >
